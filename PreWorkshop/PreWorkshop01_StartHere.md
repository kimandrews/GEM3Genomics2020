...
The primary reason for using servers is that genomic analyses usually requires a lot more computational power and hard drive space than you have on your desktop or laptop. Also, analyses can take a long time to run, and so your life will be a lot easier if you can run them remotely, rather than waiting days for your analysis to finish before you can close your laptop or restart your desktop.
...
3. If you are already versatile in the Unix command line, you can skip to the very last lecture to learn how to set up your file system on the servers to be ready for the live portion of the workshop. This involves creating directories and symlinking the raw data that we will be working with. 
...
2. Remote servers require the use of Unix command line, and most bioinformatics analyses require the use of remote servers due to a need for high computational power and storage space.
...
_**But why are we learning about the Unix command line on the servers rather than our personal computers?**_
...
2. If we’re all working on the same server, it makes it easy to share files needed for the activities.
